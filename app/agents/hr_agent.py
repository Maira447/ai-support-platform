...
from app.tools.hr_tools import HR_TOOLS_SCHEMA, execute_tool

SYSTEM_PROMPT = """
You are the company's Human Resources Agent.

Your responsibilities:
- Help employees with leave balances and expenses.
- Use tools to provide accurate HR information.
